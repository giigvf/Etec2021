...
select nome from clientes where nome like'%ana%silva%';

-- atividade 
select * from clientes where endereco like'%avenida%';
select * from cidades where nome like'%santo%';
select * from cidades where nome like '%sao%';
select * from clientes where email like '%gmail%';
select * from clientes where celular like '%(14)%';