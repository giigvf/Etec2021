...
select clientes.nome, cidades.nome from clientes inner join cidades on clientes.id_cidade = id_cidades;
select produtos.descricao, produtos.estoque, produtos.